            ...
            <div id="infosUtil">
               ...
               <ul id="menuList">
                  ...
                  <li class="smenu">
                   ...
                   <li class="smenu">
                       <a href="<?php echo e(route('chemin_test')); ?>" title="test">Test</a>
                   </li>
               <li class="smenu">
...
<?php echo $__env->make('modeles/visiteur', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gsblaravel_final\resources\views/sommaire.blade.php ENDPATH**/ ?>