<?php $__env->startSection('menu'); ?>
    ...
    <div id="menuGauche">
        ...
        <ul id="menuList">
            ...
            <li class="smenu">
                <a href="<?php echo e(route('chemin_test')); ?>" title="test">2</a>
            </li>
            <li class="smenu">
...
<?php echo $__env->make('modeles/visiteur', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gsblaravel_final\resources\views/sommaireComptable.blade.php ENDPATH**/ ?>